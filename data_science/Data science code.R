...
table(crop_recommendation$yield_category)
transform(table(crop_recommendation$yield_category))
...
summary(crop_recommendation$yield_kg_ha)
summary(crop_recommendation$yield_kg_ha)
#rainfall
summary(crop_recommendation$rainfall)
summary(crop_recommendation$rainfall)
...
table(is.na(crop_recommendation$rainfall))
...
boxplot(crop_recommendation$rainfall)
